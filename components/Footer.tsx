...
const FooterLink: React.FC<{ page: 'pricing' | 'contact' | 'terms' | 'privacy'; children: React.ReactNode }> = ({ page, children }) => {
      ...
      <div className="container mx-auto px-4 py-6">
        <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="flex flex-wrap justify-center md:justify-start gap-x-6 gap-y-2 mb-4 md:mb-0">
                <FooterLink page="pricing">Pricing</FooterLink>
                <FooterLink page="contact">Contact</FooterLink>
                <FooterLink page="terms">Terms of Service</FooterLink>
